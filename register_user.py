...
def register_new_user():
    ...
    try:
        ...
        try:
            ...
            print("1. Check if the known_faces directory exists and has proper permissions")
            print("2. Ensure the known_faces.pkl file is not corrupted")
            print("3. Try removing the known_faces.pkl file to start fresh")
            sys.exit(1)
